...
import {
  ...
  WATER_X,
  townSchematic,
} from "./town-schematic.js";

// The map data lives beside this file rather than in it, so the UI layer can read it without the
// renderer. Re-exported because the rest of the game imports these from `town.js`.
export {
  type DeckFootprint,
  type ITownSchematic,
  type SchematicRect,
