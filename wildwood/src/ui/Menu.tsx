...
/**
 * The controls line, and the one thing a UI has to do differently from a plain web app: say which
 * of its elements the player can touch.
 *
...
export function Menu() {
  ...
  return (
    <div className="pointer-events-none absolute bottom-6 left-6 flex items-center gap-3 border border-line bg-panel/75 px-4 py-3 text-[11px] uppercase tracking-[0.14em] text-dim">
      <span>click to look · wasd to walk · shift to run · space to hop · e to inspect</span>
      <button
        aria-pressed={paused}
