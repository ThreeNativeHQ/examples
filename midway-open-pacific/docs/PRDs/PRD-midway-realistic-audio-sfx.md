...
| `gun-30` / 1 s request / no | **Reconstruction**, not an authenticated recording: a single round from an aircraft-mounted thirty-caliber Browning machine gun, close and dry. The exact 450-character request text and the generation chain are recorded in `content/audio/midway-audio.json` (ElevenLabs `eleven_text_to_sound_v2`, post-processed to a 0.180 s mono one-shot). | Rear-gunner identity (.30 AN/M2). SBD-3 rear = 2 × .30 flexible, nose = 2 × .50 fixed ([National WWII Museum](https://www.nationalww2museum.org/visit/museum-campus/us-freedom-pavilion/warbirds/douglas-sbd-dauntless)); TBD-1 rear = 1 × .30. Primary .30 AN/M2 cyclic rate **not found**, so gameplay cadence is unchanged. |
