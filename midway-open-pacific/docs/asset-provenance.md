...
| `weapon.rear-gun.glb` | 1010780 | `7f9bd9a79429d71c3ca5f79de5173ad2ae0603c3b0c26cda5bb7a9c951f6a130` | `/home/joao/Downloads/dual-barrel machine gun 3d model.glb` | 0.57 x 0.57 x 1.00 | -0.38 | 4764 | `blender -b -P tools/blender/normalize-rear-gun.py -- <src> <out>` then `gltf-transform webp --quality 90 --vertex-layout separate`. Measured landmarks; the supplied source is untouched and keeps every triangle. **No licence was supplied; distribution rights UNVERIFIED.** |
