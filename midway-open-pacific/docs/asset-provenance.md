...
| `carrier.yorktown.glb` | 13223756 | `635aa852f0a2b35f458f0d0af2f54fe17d7db23b87cd1217d634cbd675a9f351` | `MM/carriers/uss-yorktown.glb` | 32.79 x 48.02 x 246.79 | 0.00 | 199999 | `bash tools/import-fleet.sh carrier.yorktown` (weld, then simplify `--ratio .11 --error .0001 --lock-border true`) |
