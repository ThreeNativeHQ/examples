...
export const SPEECH: Record<string, ISpeechRow> = {
  ...
  R32: { text: "Scout Three. Bandit on your tail and you're not turning into him. Break now.", voice: "wingman", priority: 1 },
  R33: { text: "Scout Three. You're low. Pull out. Pull out!", voice: "wingman", priority: 1 },
  R34: { text: "Scout Three. That target is already being worked over. Pick another or follow me in.", voice: "wingman", priority: 3 },
  R35: { text: "Scout Three. There's a ship ahead with its guns up. Do not overfly her.", voice: "wingman", priority: 2 },
  R36: { text: "Scout Three. You're down to fumes. Break off and head for home.", voice: "wingman", priority: 2 },
  R37: { text: "Scout Three. Your tank's been hit. You're losing fuel. Get her home.", voice: "wingman", priority: 1 },
