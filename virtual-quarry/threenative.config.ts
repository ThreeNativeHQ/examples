...
const config: IThreeNativeConfig = {
  app: {
    id: "com.threenative.virtualquarry",
    name: "virtual-quarry",
    version: "1.0.0",
    build: 1,
  ...
  window: {
    title: "virtual-quarry", // Desktop window title.
    width: 1280,
    height: 720,
    resizable: true,
  },
  ...
  assets: {
    ...
    // Left at its default on purpose: virtual geometry is a convention that ships on, and a
    // body of 524,288 triangles is exactly what it is for. Nothing else in this project asks.
    models: {},
    textures: "none",
  },
